...
class FCN_res18b(nn.Module):
    def __init__(self, in_channels=3, num_classes=7, pretrained=False):
        super(FCN_res18b, self).__init__()
        resnet = models.resnet18(pretrained=False)
        conv1 = conv3x3(in_channels, 64, stride=2)
        bn1 = nn.BatchNorm2d(64, momentum=0.95)
        conv2 = conv3x3(64, 64)
        bn2 = nn.BatchNorm2d(64, momentum=0.95)
        
        self.layer0 = nn.Sequential(conv1, bn1, nn.ReLU(), conv2, bn2, nn.ReLU())
        self.layer1 = resnet.layer1
        self.layer2 = resnet.layer2
        self.layer3 = resnet.layer3
        self.layer4 = resnet.layer4
...
class FCN_res34b(nn.Module):
    def __init__(self, in_channels=3, num_classes=7, pretrained=False):
        super(FCN_res34b, self).__init__()
        resnet = models.resnet34(pretrained=False)
        conv1 = conv3x3(in_channels, 64, stride=2)
        bn1 = nn.BatchNorm2d(64, momentum=0.95)
        conv2 = conv3x3(64, 64)
